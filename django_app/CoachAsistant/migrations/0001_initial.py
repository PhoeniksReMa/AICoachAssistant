    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(help_text='Время создания (будет записано как datetime, а не как int-метка)')),
        ...
        migrations.CreateModel(
            name='TelegramUser',
            fields=[
                ('chat_id', models.IntegerField(help_text='Уникальный идентификатор чата в Telegram', max_length=100, primary_key=True, serialize=False)),
